...
public class FeedbackController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FeedbackCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FeedbackUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FeedbackDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Feedback getFeedback(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<Feedback> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Feedback> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class FeedbackControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Feedback) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Feedback.class.getName()});
                return null;
            }
        }
